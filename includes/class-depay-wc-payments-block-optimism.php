...
final class DePay_WC_Payments_Block_Optimism extends AbstractPaymentMethodType {

	private $gateway;

	public $name = DePay_WC_Payments_Optimism_Gateway::GATEWAY_ID;

	public function initialize() {
		$this->gateway = new DePay_WC_Payments_Optimism_Gateway();
		$this->settings = array(
