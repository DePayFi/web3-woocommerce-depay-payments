...
final class DePay_WC_Payments_Block_Ethereum extends AbstractPaymentMethodType {

	private $gateway;

	public $name = DePay_WC_Payments_Ethereum_Gateway::GATEWAY_ID;

	public function initialize() {
		$this->gateway = new DePay_WC_Payments_Ethereum_Gateway();
		$this->settings = array(
