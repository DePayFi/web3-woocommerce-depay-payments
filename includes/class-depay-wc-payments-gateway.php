...
class DePay_WC_Payments_Gateway extends WC_Payment_Gateway {
	...
	public function get_icon() {
		$icon = '<style>.payment_box.payment_method_depay_wc_payments { width: 100%; } .wc_payment_method.payment_method_depay_wc_payments { display: flex; flex-direction: row; flex-wrap: wrap; } .payment_method_depay_wc_payments label { display: flex !important; flex-grow: 1; align-items: center; }</style><div style="display: inline; flex-grow: 0;">';
