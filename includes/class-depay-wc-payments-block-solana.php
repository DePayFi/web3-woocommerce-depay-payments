...
final class DePay_WC_Payments_Block_Solana extends AbstractPaymentMethodType {

	private $gateway;

	public $name = DePay_WC_Payments_Solana_Gateway::GATEWAY_ID;

	public function initialize() {
		$this->gateway = new DePay_WC_Payments_Solana_Gateway();
		$this->settings = array(
			'blockchains' => '["solana"]'
		);
	}
