...
final class DePay_WC_Payments_Block_Avalanche extends AbstractPaymentMethodType {

	private $gateway;

	public $name = DePay_WC_Payments_Avalanche_Gateway::GATEWAY_ID;

	public function initialize() {
		$this->gateway = new DePay_WC_Payments_Avalanche_Gateway();
		$this->settings = array(
