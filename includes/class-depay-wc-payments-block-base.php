...
final class DePay_WC_Payments_Block_Base extends AbstractPaymentMethodType {

	private $gateway;

	public $name = DePay_WC_Payments_Base_Gateway::GATEWAY_ID;

	public function initialize() {
		$this->gateway = new DePay_WC_Payments_Base_Gateway();
		$this->settings = array(
			'blockchains' => '["base"]'
		);
	}
