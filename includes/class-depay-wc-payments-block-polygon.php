...
final class DePay_WC_Payments_Block_Polygon extends AbstractPaymentMethodType {

	private $gateway;

	public $name = DePay_WC_Payments_Polygon_Gateway::GATEWAY_ID;

	public function initialize() {
		$this->gateway = new DePay_WC_Payments_Polygon_Gateway();
		$this->settings = array(
			'blockchains' => '["polygon"]'
		);
	}
