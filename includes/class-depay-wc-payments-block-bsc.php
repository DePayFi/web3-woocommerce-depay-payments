...
final class DePay_WC_Payments_Block_Bsc extends AbstractPaymentMethodType {

	private $gateway;

	public $name = DePay_WC_Payments_Bsc_Gateway::GATEWAY_ID;

	public function initialize() {
		$this->gateway = new DePay_WC_Payments_Bsc_Gateway();
		$this->settings = array(
			'blockchains' => '["bsc"]'
		);
	}
