...
= 2026-1-23 - v3.0.7 =
* fixes okx + oks wallet connection

= 2026-1-3 - v3.0.6 =
* fixes token denomination issue (where no price is available)

= 2025-11-4 - v3.0.5 =
* fixes Solana issues

= 2025-8-27 - v3.0.4 =
* fix: uses different urls for testing outgoing connection

= 2025-7-2 - v3.0.3 =
* fixes: ensures to load all payment options in some cases

= 2025-6-10 - v3.0.2 =
* adds debugging to failed payment tracking requests

= 2025-6-6 - v3.0.1 =
* fixes phantom wallet mobile wallet deep link
...
* fixes some solana loading issues

= 2025-1-6 - v2.12.19 =
* fixes checkout when login and account creation at checkout is enabled
